...
const AUDIO_SOURCES = ['OscillatorFlowNode','AudioWorkletOscillatorFlowNode','KarplusFlowNode','BrassFlowNode','FMFlowNode','WavetableFlowNode','NoiseFlowNode','SampleFlowNode','MicFlowNode','AudioWorkletFlowNode','AiVstFlowNode'];
